...
bool ShowNavWarning() {
  wxString msg(
      _("\n\
ITS is distributed in the hope that it will be useful, \
but WITHOUT ANY WARRANTY; without even the implied \
warranty of MERCHANTABILITY or FITNESS FOR A \
PARTICULAR PURPOSE.\n\n\
See the GNU General Public License for more details.\n\n\
ITS must only be used in conjunction with approved \
paper charts and traditional methods of navigation.\n\n\
DO NOT rely upon ITS for safety of life or property.\n\n\
Please click \"Agree\" and proceed, or \"Cancel\" to quit.\n"));

  wxString vs = wxString::Format(wxT(" .. Version %s"), VERSION_FULL);

#ifdef __ANDROID__
  androidShowDisclaimer(_("ITS for Android") + vs, msg);
  return true;
#else
  msg.Replace("\n", "<br>");
  ...
  std::string title = _("Welcome to ITS").ToStdString();
...
void MyFrame::RebuildChartDatabase() {
  ...
  if (ChartDirArray.GetCount()) {
    ...
    if (g_NeedDBUpdate == 1) {
      wxString msg1(
          _("ITS needs to update the chart database from config file "
            "entries...."));

      OCPNMessageDialog mdlg(gFrame, msg1, wxString(_("ITS Info")),
    ...
    wxGenericProgressDialog *pprog = new wxGenericProgressDialog(
        _("ITS Chart Update"), line, 100, NULL,
...
void MyFrame::RegisterGlobalMenuItems() {
...
#ifndef __WXOSX__
  nav_menu->AppendSeparator();
  nav_menu->Append(ID_MENU_OQUIT, _menuText(_("Exit ITS"), _T("Ctrl-Q")));
#endif
  ...
  help_menu->Append(wxID_ABOUT, _("About ITS"));
  help_menu->Append(wxID_HELP, _("ITS Help"));
...
void MyFrame::ProcessOptionsDialog(int rr, ArrayOfCDI *pNewDirArray) {
  ...
  if (rr & STYLE_CHANGED) {
    OCPNMessageBox(
        NULL,
        _("Please restart ITS to activate language or style changes."),
        _("ITS Info"), wxOK | wxICON_INFORMATION);
  }
...
bool MyFrame::UpdateChartDatabaseInplace(ArrayOfCDI &DirArray, bool b_force,
  ...
  if (b_prog) {
    wxString longmsg = _("ITS Chart Update");
    longmsg +=
        _T("..................................................................")
        _T("........");
    ...
    pprog->Create(_("ITS Chart Update"), longmsg, 100, gFrame,
                  wxPD_SMOOTH | wxPD_ELAPSED_TIME | wxPD_ESTIMATED_TIME |
                      wxPD_REMAINING_TIME);
...
ocpnToolBarSimple *MyFrame::CreateMasterToolbar() {
  ...
  tic = new ToolbarItemContainer(
      ...
      wxITEM_NORMAL, _("About ITS"), _T("MUI_help"));
  g_MainToolbar->AddToolItem(tic);
