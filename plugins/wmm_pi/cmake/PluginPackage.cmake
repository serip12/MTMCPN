...
SET(CPACK_PACKAGE_EXECUTABLES ITS ${PACKAGE_NAME})
...
SET(CPACK_NSIS_DISPLAY_NAME "ITS ${PACKAGE_NAME}")
...
if (NOT OCPN_PACKAGE_RELEASE)
  ...
  ENDIF ()
    ...
    SET(CPACK_PACKAGE_DESCRIPTION_SUMMARY "${PACKAGE_NAME} PlugIn for ITS")
    SET(CPACK_PACKAGE_DESCRIPTION "${PACKAGE_NAME} PlugIn for ITS")
