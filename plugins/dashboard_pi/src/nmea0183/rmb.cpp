...
bool RMB::Parse(const SENTENCE& sentence) {
  ...
  ** 14) Checksum
  ...
  Version 2.3
  ** 14) FAA Mode Indicatior, The value can be A=autonomous, D=differential,
  E=Estimated, N=not valid, S=Simulator, optional, may be NULL
  ** 15) Checksum
  */
  ...
  */
  ...
  // If sentence is at least Version 2.3, check the extra FAA mode indicator
  // field
